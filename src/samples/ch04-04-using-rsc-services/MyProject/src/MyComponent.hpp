...
//#acfcomponent
class MyComponent : public ComponentBase, private Loggable<MyComponent>
{
public: // typedefs
...
private:
    IDeviceInfoService::Ptr deviceInfoServicePtr = nullptr;  // Pointer to the device info service
};
